...
export function Newsletter() {
  ...
  return (
    <section className="bg-linear-to-r mx-auto py-16 lg:py-24 text-primary-foreground">
      <div className="px-4 container">
        <div className="mx-auto max-w-3xl text-center">
          ...
          {isSuccess ? (
            ...
            <form onSubmit={handleSubmit} className="flex sm:flex-row flex-col gap-4 mx-auto max-w-md">
