Phase 1: Foundation & State Management
  ...
  Phase 2: Core E-commerce Features
   4. Product Data & SSR/ISG: The /api/products route uses static data, which I will keep for now. I will implement data fetching on the product pages 
      using React Query. For the product detail page (/products/[handle]), I will use React Query to fetch the product data and implement 
  ...
  Phase 3: Checkout & UI/UX Polish
   ...
   8. UI/UX and Animations: I will install and integrate motion/react to add page transition animations and subtle animations to UI elements. I will 
